...
currProg=$(sed -n -e 8p /home/blueteam/Stats.txt)
totHints=$(sed -n -e 9p /home/blueteam/Stats.txt)
...
sshpass -p BiermanProductions7682 ssh -o StrictHostKeyChecking=no hostsystem@10.1.1.15 "sed -i '8s/.*/$currProg/' Desktop/Stats.txt; exit"
sshpass -p BiermanProductions7682 ssh -o StrictHostKeyChecking=no hostsystem@10.1.1.15 "sed -i '9s/.*/$totHints/' Desktop/Stats.txt; exit"